...
import com.example.madesubmission1.external.receiver.DailyAlarmReceiver
...
class DailyAlarmManager(private val applicationContext: Context) : BaseAlarmManager() {

    private val calendarHelper = CalendarHelper()

    override fun getIntent(): Intent {
        return Intent(applicationContext, DailyAlarmReceiver::class.java)
    }

    override fun getTimeToFirstTrigger(): Long {
        return calendarHelper.getExpectedTimeInterval(7, 0)
    }
